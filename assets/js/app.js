msg_array = [
    ...
    "Поздравляем тебя с 8 марта и желаю всего самого наилучшего. Ты очень умная и красивая женщина!",
    ...
    "С наступающим 8 марта! Пусть этот день принесет тебе много тепла, любви и заботы.",
    "Поздравляю с весенним праздником! Желаю быть счастливой и любимой!",
    "С 8 марта! Будь всегда такой же прекрасной и уверенной в себе!",
    "Поздравляю с 8 марта! Желаю оставаться такой же яркой и прекрасной!",
    ...
    "С наступающим 8 Марта! Я желаем тебе быть счастливой и удачливой во всех твоих начинаниях!",
    "Поздравляем с 8 марта! Желеаем, чтобы твоя жизнь была наполнена радостью и счастьем!",
